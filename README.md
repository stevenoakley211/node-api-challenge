...
- [x] Describe Middleware?
    - A function that takes in the req,res and next variables and then does something with them and then returns via next.
- [x] Describe a Resource?
    - A dataset or database that the server serves.

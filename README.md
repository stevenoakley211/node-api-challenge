...
- [ ] Describe Middleware?
small applications that are passed in variable that the middleware either changes or checks for some needed requirement and then returns catches and sends an error or message of some sort
- 
[ ] Describe a Resource?


- [ ] What can the API return to help clients know if a request was successful?
by sending a status code and a message.

- [ ] How can we partition our application into sub-applications?
by using routers and middleware 
